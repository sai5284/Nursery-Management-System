...
$db = new mysqli("localhost", "root", "mysql", "onlinenursery2020");
...
. '<td>' ."<a href=book1.php?a=".$a."&b=".$b.">To Book Click here</a>" .'</td>'

	. '<td>' ."<a href=rateassignment.php?id=".$f."&ano=".$d.">Delete</a>" .'</td>'
	  . '</tr>';
}
