...
/////////////////
$mysqli= new mysqli("localhost", "root", "", "nursery2020");
...
$sql="select * from  admin where u ='{$uname}' and  p= '{$op}'";
//echo $sql;
$found=0;
...
if($np==$cp  && $found==1)
{
	...
	mysqli_select_db($con,"nursery2020");

$query="update admin set p='{$np}'  where u='{$uname}'";
